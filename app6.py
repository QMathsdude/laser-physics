...
class FabryPerotApp(tb.Frame):
    ...
    def __init__(self, root):
        ...
        self.curv1 = tb.DoubleVar(master=self, value=100)            # Radius of curvature mirror 1
        self.curv2 = tb.DoubleVar(master=self, value=100)            # Radius of curvature mirror 1
    ...
    def update_g1g2(self, *args):
        ...
        R1 = self.curv1.get() * self.MM
        R2 = self.curv2.get() * self.MM
