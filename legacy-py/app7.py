...
class FabryPerotApp(tb.Frame):
    ...
    def __init__(self, root):
        ...
        self.curv1 = tb.DoubleVar(master=self, value=10)            # Radius of curvature mirror 1
        self.curv2 = tb.DoubleVar(master=self, value=10)            # Radius of curvature mirror 1
        ...
        self.g1.trace_add("write", self.update_graph)
        self.g2.trace_add("write", self.update_graph)
    ...
    def create_graphs(self):
        ...
        self.graph_frame.grid(row=1, column=0, columnspan=2, pady=0, padx=0, sticky=NSEW)
        ...
        self.g1g2_marker = self.ax3.scatter(self.g1.get(), self.g2.get(), color='crimson', marker='o', s=10, label='$(g_1, g_2)$', zorder=1)
    ...
    def create_sliders(self):
        ...
        self.curv1_frame.grid(row=2, column=0, sticky=EW, padx=10, pady=5)
        ...
        self.curv2_frame.grid(row=2, column=1, sticky=EW, padx=10, pady=5)
    ...
    def create_lens_diagram(self):
        # Creation of graph frame
        self.lens_frame = tb.Labelframe(self.main_frame, text="Interference Pattern and Finesse", bootstyle="danger")
        self.lens_frame.grid(row=2, column=1, pady=0, padx=0, sticky=NSEW)
        ...
        # 1. Intensity Distribution Plot
        self.ax4.set_title(r"Intensity Distribution, $\mathbf{I}$", fontsize=12)
        self.fringes = self.ax4.imshow(self.intensity, cmap='hot', aspect='equal')
        self.colorbar = self.fig2.colorbar(self.fringes, ax=self.ax4, orientation='vertical', fraction=0.05, pad=0.05)
        
        # Add canvas to tkinter
        self.canvas2 = FigureCanvasTkAgg(self.fig2, master=self.lens_frame)
    ...
    def validate_curv1(self, curv1):
        ...
        try: 
            ...
            if 1.00 <= value <= 20.00 and len(curv1.split('.')[-1]) <= 2: return True 
            else: return False
        except ValueError:
            return False 
    ...
    def validate_curv2(self, curv2):
        ...
        try: 
            ...
            if 1.00 <= value <= 20.00 and len(curv2.split('.')[-1]) <= 2: return True 
            else: return False
        except ValueError:
            return False 
