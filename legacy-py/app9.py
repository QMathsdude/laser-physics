...
class FabryPerotApp(tb.Frame):
    ...
    def create_main(self):
        ...
        # 3X2 Grid Layout
        for i in range(2): self.main_frame.rowconfigure(i, weight=0)
        ...
        self.main_frame.columnconfigure(1, weight=1, uniform="col")  # Graph row expands
        ...
        description_box.grid(row=0, column=0, columnspan=2, sticky=EW, padx=10, pady=5)
    ...
    def create_graphs(self):
        ...
        self.graph_frame.grid(row=1, column=1, pady=0, padx=0, sticky=NSEW)
        ...
        # 4. Cavity diagram
        self.ax4.set_title("Diagram of Fabry-Perot Mirrors")
        self.ax4.set_xlim(-self.g_max, self.g_max)
        self.ax4.set_ylim(-self.g_max, self.g_max)
        self.ax4.axhline(y=0.0, color='black', ls='--', lw=0.8)
        self.ax4.axvline(x=0.0, color='black', ls='--', lw=0.8)
        self.ax4.grid(ls=':', alpha=0.8)
    ...
    def create_sliders(self):
        ...
        for i in range(7): self.slider_frame.rowconfigure(i, weight=0)
