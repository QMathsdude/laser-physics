...
class FabryPerotApp(tb.Frame):
    ...
    def create_graphs(self):
        ...
        # self.ax3.plot(self.g_arr_left,  1 / self.g_arr_left, color='darkorange')
        self.ax3.fill_between(self.g_arr_right, 1 / self.g_arr_right, color="seagreen", edgecolor="seagreen", alpha=0.3, linewidth=1.5) # fill are beneath curve
        self.ax3.fill_between(self.g_arr_left, 1 / self.g_arr_left, color="royalblue", edgecolor="royalblue", alpha=0.3, linewidth=1.5)
